...
{
    // Unit tests for the Pay-by-Square generator. The LZMA-SDK NuGet is used
    // HERE ONLY — as an independent decoder to verify round-trips — the
    // generator (src) itself has no third-party dependencies.
